...
def kalman_beta_filter(x, y, Q, R, beta0=None, P0=1.0, n0_beta_0 = 0.0375):
    """
    ...
    if n0_beta_0 > 1 :
        raise Exception("Error: n0_beta_0 is a percentage length of data")
    # init beta
    beta = init_beta0_ols_no_intercept(x, y, n0_beta_0 = n0_beta_0) if beta0 is None else float(beta0)
    P = float(P0)
